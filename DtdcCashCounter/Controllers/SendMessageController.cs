...
namespace DtdcCashCounter.Controllers
{
    ...
    public class SendMessageController : Controller
    {
        ...
        public ActionResult Pickupmsg(Sendmessage sendmessage)
        {
          ...
          //  string phone = db.Receipt_details.Where(m => m.Consignment_No == sendmessage.Consignment_No).Select(m => m.sender_phone).FirstOrDefault();
            ...
            {
                sendmessage.PF_Code = Session["pfCode"].ToString();
                sendmessage.User_Id = Convert.ToInt64(Session["EmpId"]);
                ...
                sendmessage.datetime_msg = localTime;
        ...
        public ActionResult SendBulkmsg()
        {
            ...
            List<Receipt_details> list = db.Receipt_details.Where(m =>  m.User_Id == User_Id).ToList();
